...
<div class="col-md-12">
    ...
    <div id="layoutSidenav_content">
      ...
      <div class="card-body">
      <table id="datatablesSimple" class="table table-bordered"style="">
...
if($usertype==3){
  ...
  $sql=mysqli_query($conn,"SELECT * from user_productivity $condition  ORDER BY (id) DESC");
}
else {
