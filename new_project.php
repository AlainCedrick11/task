	...
	<div class="card card-outline card-primary">
          	...
          	<div class="col-md-6">
				<div class="form-group">
					...
					<select name="status" id="status" class="custom-select custom-select-sm" required="">
						...
						<!--<option value="3" <?php echo isset($status) && $status == 3 ? 'selected' : '' ?>>Progressing</option>-->
      ...
      <?php endif; ?>
    	...
    	<div class="card-footer border-top border-info">
    		...
    		<button class="btn btn-flat  bg-gradient-primary mx-2" type="submit" form="manage-project">Save</button>
