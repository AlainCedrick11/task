        ...
        <div class="card card-outline card-success">
          ...
          <div class="card-body p-0">
            <div class="table-responsive">
              <table class="table m-0 table-hover table table-bordered">
                <colgroup>
                  <col width="5%">
                  <col width="30%">
                  <col width="30%">
                ...
                <thead>
                  ...
                  <th><u>Tasks Progress</u></th>
                  <th><u>Project Status</u></th>
                  <th><u>View Details</u></th>
                </thead>
                <tbody>
                <?php
                $i = 1;
                $stat = array("Pending","Opened","Opened","Progressing","Over Due","Completed");
                $where = "";
                if($_SESSION['login_type'] == 2){
                  $where = " where manager_id = '{$_SESSION['login_id']}' ";
                }elseif($_SESSION['login_type'] == 3){
                ...
                $qry = $conn->query("SELECT * FROM project_list $where ORDER by (id) DESC");
                  ...
                  <tr>
                      ...
                      <td class="project-state">
                          <?php
                            ...
                            }elseif($stat[$row['status']] =='Progressing'){
           ...
           <div class="col-12 col-sm-6 col-md-12">
            <div class="small-box bg-secondary shadow-sm border">
              <div class="inner">
                ...
                <p>Tasks On Progressing Stage</p>
              </div>
              <div class="icon">
                <i class="fa fa-tasks"></i>
              </div>
