...
$stat = array("Ongoing","Opened","Opened","Progressing","Over Due","Completed");
$qry = $conn->query("SELECT * FROM project_list where id = ".$_GET['id'])->fetch_array();
foreach($qry as $k => $v){
	$$k = $v;
}
$tprog = $conn->query("SELECT * FROM task_list where project_id = {$id}")->num_rows;
$cprog = $conn->query("SELECT * FROM task_list where project_id = {$id} and status = 1 or 2 or 3 or 4")->num_rows;
							...
							<dl>
								...
								<dd>
									<?php
									  ...
									  }elseif($stat[$status] =='Progressing'){
		...
		<div class="col-md-4">
			<div class="card card-outline card-primary">
				<div class="card-header">
					<span><b>Assigned Team Member/s:</b></span>
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<?php if($_SESSION['login_type'] != 3 or 2): ?>
					<div class="card-tools">
				...
				<div class="card-body p-0">
					...
					<table class="table table-condensed m-0 table-hover table table-bordered">
						<colgroup>
							<col width="5%">
							<col width="25%">
							<col width="30%">
						...
						<tbody>
							...
							while($row=$tasks->fetch_assoc()):
								...
								//$desc = strtr(html_entity_decode($row['filename']),$trans);
								...
								<tr>
			                        ...
			                        <td>
			                        	...
			                        	if($row['status'] == 1){
									  		...
									  		echo "<span class='badge badge-secondary'>25%</span>";
			                        	}elseif($row['status'] == 3){
									  		echo "<span class='badge badge-primary'>100%</span>";
									  			}
									  			elseif($row['status'] == 4){
									  		echo "<span class='badge badge-danger'>50%</span>";
									  			}
			                        	?>
			                        </td>
			                        <td class="text-center">
					                    ...
					                    <div class="dropdown-menu" style="">
					                      <a class="dropdown-item view_task" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">View Task</a>
					                      <div class="dropdown-divider"></div>
					                      <?php if($_SESSION['login_type'] != 3 or 2): ?>
					                      <a class="dropdown-item edit_task" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">Change Task Status</a>
					                       <!--<div class="dropdown-divider"></div>
						...
						<div class="post">
		                      ...
		                      <div class="user-block">
								  ...
								  <div class="dropdown-menu">
								  	<a class="dropdown-item manage_progress" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">Change Productivity</a>
			                      	<div class="dropdown-divider"></div>
				                     <a class="dropdown-item delete_progress" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>">Delete Productivity</a>
								  </div>
								</span>
								<?php endif; ?>
		                        ...
		                        <span class="description">
		                        	...
		                        	<span> | </span>
                      				...
                      				<!---<span>Attached File: <b><?php echo ucwords($row['filename']) ?> </b></span>--->
