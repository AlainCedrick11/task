  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#008080;"><br>
   <div class="right_bar" style="text-align: center;">
    <div class="sponsor_button"><img src="images/riblogo.png" alt="Logo";></div class="sponsor_button">
    </div>
