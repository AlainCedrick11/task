		...
		<div class="">
         <table  class="table table-bordered" id="list">
				...
				<tbody>
					...
					$stat = array("Ongoing","Started","On-Progress","Progressing","Over Due","Done");
					$qry = $conn->query("SELECT t.*,p.name as pname,p.start_date,p.status as pstatus, p.end_date,p.id as pid FROM task_list t inner join project_list p on p.id = t.project_id $where order by (p.id) desc");
					...
					<tr>
						...
						<td class="text-center">
							<?php
							  ...
							  }elseif($stat[$row['pstatus']] =='Progressing'){
						...
						<td>
                        	...
                        	elseif($row['status'] == 4){
						  		echo "<span class='badge badge-danger'>Reopened</span>";
                        	}
                        	?>
                        </td>
						<td class="text-center">
